...
export async function action({ request, params }) {
  ...
  if (actionType === "delete" && params.id) {
    ...
    return redirect("/app/eligibilityselection");
  }
  ...
  if (params.id === "new") {
    ...
    const NewRecordID = jsonResponse.data.metaobjectCreate.metaobject.id
      ...
      .pop();
    return redirect(
      `/app/eligibilityselectionid/${NewRecordID}?successMessage=Record created successfully`,
    );
  }
  ...
  if (params.id !== "new") {
    ...
    return redirect(
      `/app/eligibilityselectionid/${params.id}?successMessage=Record updated successfully`,
    );
  }
}
  ...
  return (
    <Page
      backAction={{
        ...
        url: "/app/eligibilityselection",
      }}
      title={
        formState.id ? "Edit Eligibility Criteria" : "Add Eligibility Criteria"
      }
    >
      {!!successMessage && (
        <>
        ...
        <Card>
          <BlockStack gap="500">
            <TextField
              ...
              onChange={(value) =>
                setFormState({ ...formState, eligibility_criteria: value })
              }
